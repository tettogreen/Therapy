...
public class CameraFade : MonoBehaviour {
	...
	{		
		...
		StartCoroutine(StartFade(targetColor, fadeTime, delayTime));
	}
	...
	{
		StartCoroutine (StartFade(newScreenOverlayColor, fadeDuration, 0));
	}

	IEnumerator StartFade (Color newScreenOverlayColor, float fadeDuration, float delay)
	{
